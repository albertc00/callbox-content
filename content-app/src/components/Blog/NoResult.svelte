...
<div class="no-results svelte-19bcstx">
  <div class="wrapper svelte-19bcstx">
    ...
    <p class="message svelte-19bcstx">
      Sorry, no posts matched your criteria. Please try another search You might<br
      />
      want to consider some of our suggestions to get better results:
    </p>
  </div>
</div>
<ul class="noresultlist">
  <div class="message svelte-19bcstx">
...
<style>
  ...
  .no-results.svelte-19bcstx {
    text-align: center;
  }

  .message.svelte-19bcstx {
